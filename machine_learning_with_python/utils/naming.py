...
def magic_name(value, *, path_prefix):
    ...
    try:
        ...
        # https://github.com/machine_learning_with_python/machine_learning_with_python/pull/1635
        if inspect.isframe(frame):
            frame = frame.f_back

        # Iterate frames while filename starts with path_prefix (part of machine_learning_with_python)
