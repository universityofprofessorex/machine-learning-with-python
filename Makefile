...
MAKE := make
PY_MODULE_NAME := machine-learning-with-python
...
PACKAGE_NAME="machine-learning-with-python"
...
RTD_DOC_URL="https://machine-learning-with-python.readthedocs.io/index.html"
...
run-black-check: ## CHECK MODE: sensible pylint ( Lots of press over this during pycon 2018 )
	black --check --exclude=machine-learning-with-python_venv*,*.eggs --verbose .

.PHONY: run-black
run-black: ## sensible pylint ( Lots of press over this during pycon 2018 )
	black --verbose --exclude=machine-learning-with-python_venv*,*.eggs .
